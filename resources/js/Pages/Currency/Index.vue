...
import { XCircleIcon, XIcon, CheckCircleIcon } from "@heroicons/vue/outline";
...
function submit() {
  Inertia.post(route("currencies.store"), form);
  open.value = false;
}
</script>
    ...
    <div class="mt-8 px-4 sm:px-6 lg:px-8">
      <div class="sm:flex sm:items-center">
        <div class="sm:flex-auto">
          <h1 class="text-xl font-semibold text-gray-900">Currencies</h1>
          <p class="mt-2 text-sm text-gray-700">
            A list of all the currencies being traded.
          </p>
        </div>
            ...
            <tr v-for="currency in currencies" :key="currency.id">
              ...
              >
                <a href="#" class="text-indigo-600 hover:text-indigo-900"
                  >Edit<span class="sr-only">, {{ currency.name }}</span></a
                >
              </td>
            </tr>
          </tbody>
