  ...
  <AppLayout>
    ...
    <div class="px-4 sm:px-6 lg:px-8">
      ...
      <div class="mt-8 bg-white shadow overflow-hidden sm:rounded-lg">
        ...
        <p class="mt-1 max-w-2xl text-sm text-gray-500">Specific details of the user.</p>
        </div>
        ...
        <dl>
            ...
            <div class="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
            <dt class="text-sm font-medium text-gray-500">Account Created On</dt>
            <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">{{ user.created_at }}</dd>
            </div>
            <div v-if="user.deactivated">
                <div class="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                <dt class="text-sm font-medium text-gray-500">Deactivated On</dt>
                <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">{{ transaction.rate }}</dd>
                </div>
            </div>
        </dl>
        </div>
